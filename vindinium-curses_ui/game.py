...
class Game:
    ...
    def process_board(self, board):
        ...
        self.map = vin.Map(self.board_size)
        ...
        for y in range(0, len(tiles), self.board_size * 2):
            ...
            for x in range(0, len(line), 2):
                ...
                if tile[0] == " ":
                    # It's passable
                    char = " "
                    self.map[tile_coords[1], tile_coords[0]] = vin.TILE_EMPTY
                elif tile[0] == "#":
                    # It's a wall
                    char = "#"
                    self.walls_locs.append(tile_coords)
                    self.map[tile_coords[1], tile_coords[0]] = vin.TILE_WALL
                elif tile[0] == "$":
                    # It's a mine
                    char = "$"
                    self.mines_locs.append(tile_coords)
                    self.mines[tile_coords] = tile[1]
                    self.map[tile_coords[1], tile_coords[0]] = vin.TILE_MINE
                    ...
                    self.map[tile_coords[1], tile_coords[0]] = vin.TILE_TAVERN
                elif tile[0] == "@":
                    # It's a hero
                    char = "H"
                    self.map[tile_coords[1], tile_coords[0]] = vin.TILE_SPAWN
